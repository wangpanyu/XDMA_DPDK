...
Panyu Wang, Yazhou Wang, Congwu Zhang, Bibo Yang, Mingyu Chen, Yungang Bao and Ke Zhang.  
**Aperture: A Software-Defined Interconnect for Multi-FPGA Prototyping Systems.**  
2026 36th International Conference on Field-Programmable Logic and Applications (FPL), Ghent, Belgium, 2026.

```bibtex
@inproceedings{heteroproto,
  address = {Ghent, Belgium},
  title = {Aperture: A Software-Defined Interconnect for Multi-FPGA Prototyping Systems},
  shorttitle = {Aperture},
